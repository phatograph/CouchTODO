...
var user_info = { "users_list" :
  ...
  var question_info = {"questions_list" :
    {"1": {"question": "question description strings", "user": user_info.users_list[1].username , "date": Date.now(), "category": "category strings", "popularity": 1, "answers":
      {"1": {"answer":"test", "date": Date.now(), "user": user_info.users_list[1].username, "popularity": "1"}}},
      "2": {"question": "question description strings", "user": user_info.users_list[1].username , "date": Date.now(), "category": "category strings", "popularity": 1, "answers":
        {"1": {"answer":"test", "date": Date.now(), "user": user_info.users_list[1].username, "popularity": "1"}}}
    }};
